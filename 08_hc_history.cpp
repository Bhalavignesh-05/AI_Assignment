...
PathResult hill_climbing_history(const Graph& g, const Heuristics& h, char start, char goal) {
...
int main() {
    PathResult result = hill_climbing_history(graph, heuristics, START_NODE, GOAL_NODE);
    print_result("Hill Climbing with History", result);
    return 0;
}